import { IsNotEmpty, IsNumberString, IsString, Length, Matches, MaxLength, MinLength} from "class-validator";
...
export class LogInDto {
    ...
    @ApiProperty({
        description: 'Credential the user will use for login, it can be the username or the email',
